...
<template>
  <div class="mx-auto my-10 py-5 w-1/2 grid place-content-center">
    ...
    <div class="mt-4 border border-neutral-400 rounded-lg px-8 py-4">
      ...
      <div
        ...
        class="my-2 px-6 py-3 border border-neutral-500 rounded-xl"
      >
        <div class="flex gap-3 items-center mb-2">
          <img
            :src="comment.avatar"
            alt="profile pic"
            class="size-10 border border-neutral-400 rounded-full"
          />
      ...
      <form class="mt-2" @submit.prevent="createComment">
        ...
        <label class="flex gap-2">
          ...
          <textarea
            ...
            class="border w-150 h-30 rounded-md"
            placeholder="Type the comment..."
          ></textarea>
        </label>
        <button
          class="mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 cursor-pointer"
          type="submit"
        >
          Submit
        </button>
